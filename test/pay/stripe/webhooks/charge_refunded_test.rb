...
class Pay::Stripe::Webhooks::ChargeRefundedTest < ActiveSupport::TestCase
  ...
  test "a charge is updated with refunded amount" do
    ...
    charge = @user.charges.create!(processor_id: @event.data.object.id, amount: 500, card_type: 'Visa', card_last4: '4444', card_exp_month: 1, card_exp_year: 2019)
  ...
  test "a charge isn't updated with the refunded amount if a corresponding charge can't be found (obviously)" do
    ...
    charge = @user.charges.create!(processor_id: 'doesntexist', amount: 500, card_type: 'Visa', card_last4: '4444', card_exp_month: 1, card_exp_year: 2019)
